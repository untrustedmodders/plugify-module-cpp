...
namespace cross_call_master {
	...
	inline void Param5Callback(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e) {
		using Param5CallbackFn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&);
	...
	inline void Param6Callback(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f) {
		using Param6CallbackFn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char);
	...
	inline void Param7Callback(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f, const plg::string& g) {
		using Param7CallbackFn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char, const plg::string&);
	...
	inline void Param8Callback(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f, const plg::string& g, char16_t h) {
		using Param8CallbackFn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char, const plg::string&, char16_t);
	...
	inline void Param9Callback(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f, const plg::string& g, char16_t h, int16_t k) {
		using Param9CallbackFn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char, const plg::string&, char16_t, int16_t);
	...
	inline void Param10Callback(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f, const plg::string& g, char16_t h, int16_t k, void* l) {
		using Param10CallbackFn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char, const plg::string&, char16_t, int16_t, void*);
	...
	inline void ParamRef5Callback(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e) {
		using ParamRef5CallbackFn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&);
	...
	inline void ParamRef6Callback(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f) {
		using ParamRef6CallbackFn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&);
	...
	inline void ParamRef7Callback(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f, plg::string& g) {
		using ParamRef7CallbackFn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&, plg::string&);
	...
	inline void ParamRef8Callback(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f, plg::string& g, char16_t& h) {
		using ParamRef8CallbackFn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&, plg::string&, char16_t&);
	...
	inline void ParamRef9Callback(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f, plg::string& g, char16_t& h, int16_t& k) {
		using ParamRef9CallbackFn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&, plg::string&, char16_t&, int16_t&);
	...
	inline void ParamRef10Callback(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f, plg::string& g, char16_t& h, int16_t& k, void*& l) {
		using ParamRef10CallbackFn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&, plg::string&, char16_t&, int16_t&, void*&);
	...
	using FuncBoolVector = std::vector<bool> (*)();
	inline std::vector<bool> CallFuncBoolVectorCallback(FuncBoolVector func) {
		using CallFuncBoolVectorFn = std::vector<bool> (*)(FuncBoolVector);
	...
	using FuncChar8Vector = std::vector<char> (*)();
	inline std::vector<char> CallFuncChar8VectorCallback(FuncChar8Vector func) {
		using CallFuncChar8VectorFn = std::vector<char> (*)(FuncChar8Vector);
	...
	using FuncChar16Vector = std::vector<char16_t> (*)();
	inline std::vector<char16_t> CallFuncChar16VectorCallback(FuncChar16Vector func) {
		using CallFuncChar16VectorFn = std::vector<char16_t> (*)(FuncChar16Vector);
	...
	using FuncInt8Vector = std::vector<int8_t> (*)();
	inline std::vector<int8_t> CallFuncInt8VectorCallback(FuncInt8Vector func) {
		using CallFuncInt8VectorFn = std::vector<int8_t> (*)(FuncInt8Vector);
	...
	using FuncInt16Vector = std::vector<int16_t> (*)();
	inline std::vector<int16_t> CallFuncInt16VectorCallback(FuncInt16Vector func) {
		using CallFuncInt16VectorFn = std::vector<int16_t> (*)(FuncInt16Vector);
	...
	using FuncInt32Vector = std::vector<int32_t> (*)();
	inline std::vector<int32_t> CallFuncInt32VectorCallback(FuncInt32Vector func) {
		using CallFuncInt32VectorFn = std::vector<int32_t> (*)(FuncInt32Vector);
	...
	using FuncInt64Vector = std::vector<int64_t> (*)();
	inline std::vector<int64_t> CallFuncInt64VectorCallback(FuncInt64Vector func) {
		using CallFuncInt64VectorFn = std::vector<int64_t> (*)(FuncInt64Vector);
	...
	using FuncUInt8Vector = std::vector<uint8_t> (*)();
	inline std::vector<uint8_t> CallFuncUInt8VectorCallback(FuncUInt8Vector func) {
		using CallFuncUInt8VectorFn = std::vector<uint8_t> (*)(FuncUInt8Vector);
	...
	using FuncUInt16Vector = std::vector<uint16_t> (*)();
	inline std::vector<uint16_t> CallFuncUInt16VectorCallback(FuncUInt16Vector func) {
		using CallFuncUInt16VectorFn = std::vector<uint16_t> (*)(FuncUInt16Vector);
	...
	using FuncUInt32Vector = std::vector<uint32_t> (*)();
	inline std::vector<uint32_t> CallFuncUInt32VectorCallback(FuncUInt32Vector func) {
		using CallFuncUInt32VectorFn = std::vector<uint32_t> (*)(FuncUInt32Vector);
	...
	using FuncUInt64Vector = std::vector<uint64_t> (*)();
	inline std::vector<uint64_t> CallFuncUInt64VectorCallback(FuncUInt64Vector func) {
		using CallFuncUInt64VectorFn = std::vector<uint64_t> (*)(FuncUInt64Vector);
	...
	using FuncPtrVector = std::vector<void*> (*)();
	inline std::vector<void*> CallFuncPtrVectorCallback(FuncPtrVector func) {
		using CallFuncPtrVectorFn = std::vector<void*> (*)(FuncPtrVector);
	...
	using FuncFloatVector = std::vector<float> (*)();
	inline std::vector<float> CallFuncFloatVectorCallback(FuncFloatVector func) {
		using CallFuncFloatVectorFn = std::vector<float> (*)(FuncFloatVector);
	...
	using FuncStringVector = std::vector<plg::string> (*)();
	inline std::vector<plg::string> CallFuncStringVectorCallback(FuncStringVector func) {
		using CallFuncStringVectorFn = std::vector<plg::string> (*)(FuncStringVector);
	...
	using FuncDoubleVector = std::vector<double> (*)();
	inline std::vector<double> CallFuncDoubleVectorCallback(FuncDoubleVector func) {
		using CallFuncDoubleVectorFn = std::vector<double> (*)(FuncDoubleVector);
	...
	using Func5 = bool (*)(int8_t, const plg::vec2&, void*, double, const std::vector<uint64_t>&);
	...
	using Func6 = int64_t (*)(const plg::string&, float, const std::vector<float>&, int16_t, const std::vector<uint8_t>&, void*);
	...
	using Func7 = double (*)(const std::vector<char>&, uint16_t, char16_t, const std::vector<uint32_t>&, const plg::vec4&, bool, uint64_t);
	...
	using Func8 = plg::mat4x4 (*)(const plg::vec3&, const std::vector<uint32_t>&, int16_t, bool, const plg::vec4&, const std::vector<char16_t>&, char16_t, int32_t);
	...
	using Func9 = void (*)(float, const plg::vec2&, const std::vector<int8_t>&, uint64_t, bool, const plg::string&, const plg::vec4&, int16_t, void*);
	...
	using Func10 = uint32_t (*)(const plg::vec4&, const plg::mat4x4&, const std::vector<uint32_t>&, uint64_t, const std::vector<char>&, int32_t, bool, const plg::vec2&, int64_t, double);
	...
	using Func11 = void* (*)(const std::vector<bool>&, char16_t, uint8_t, double, const plg::vec3&, const std::vector<int8_t>&, int64_t, uint16_t, float, const plg::vec2&, uint32_t);
	...
	using Func12 = bool (*)(void*, const std::vector<double>&, uint32_t, double, bool, int32_t, int8_t, uint64_t, float, const std::vector<void*>&, int64_t, char);
	...
	using Func13 = plg::string (*)(int64_t, const std::vector<char>&, uint16_t, float, const std::vector<bool>&, const plg::vec4&, const plg::string&, int32_t, const plg::vec3&, void*, const plg::vec2&, const std::vector<uint8_t>&, int16_t);
	...
	using Func14 = std::vector<plg::string> (*)(const std::vector<char>&, const std::vector<uint32_t>&, const plg::mat4x4&, bool, char16_t, int32_t, const std::vector<float>&, uint16_t, const std::vector<uint8_t>&, int8_t, const plg::vec3&, const plg::vec4&, double, void*);
	inline std::vector<plg::string> CallFunc14Callback(Func14 func) {
		using CallFunc14Fn = std::vector<plg::string> (*)(Func14);
	...
	using Func15 = int16_t (*)(const std::vector<int16_t>&, const plg::mat4x4&, const plg::vec4&, void*, uint64_t, const std::vector<uint32_t>&, bool, float, const std::vector<char16_t>&, uint8_t, int32_t, const plg::vec2&, uint16_t, double, const std::vector<uint8_t>&);
	...
	using Func16 = void* (*)(const std::vector<bool>&, int16_t, const std::vector<int8_t>&, const plg::vec4&, const plg::mat4x4&, const plg::vec2&, const std::vector<uint64_t>&, const std::vector<char>&, const plg::string&, int64_t, const std::vector<uint32_t>&, const plg::vec3&, float, double, int8_t, uint16_t);
	...
	using Func19 = void (*)(uint32_t&, plg::vec3&, std::vector<uint32_t>&);
	...
	using Func20 = int32_t (*)(char16_t&, plg::vec4&, std::vector<uint64_t>&, char&);
	...
	using Func21 = float (*)(plg::mat4x4&, std::vector<int32_t>&, plg::vec2&, bool&, double&);
	...
	using Func22 = uint64_t (*)(void*&, uint32_t&, std::vector<double>&, int16_t&, plg::string&, plg::vec4&);
	...
	using Func23 = void (*)(uint64_t&, plg::vec2&, std::vector<int16_t>&, char16_t&, float&, int8_t&, std::vector<uint8_t>&);
	...
	using Func24 = plg::mat4x4 (*)(std::vector<char>&, int64_t&, std::vector<uint8_t>&, plg::vec4&, uint64_t&, std::vector<void*>&, double&, std::vector<void*>&);
	...
	using Func25 = double (*)(int32_t&, std::vector<void*>&, bool&, uint8_t&, plg::string&, plg::vec3&, int64_t&, plg::vec4&, uint16_t&);
	...
	using Func26 = char (*)(char16_t&, plg::vec2&, plg::mat4x4&, std::vector<float>&, int16_t&, uint64_t&, uint32_t&, std::vector<uint16_t>&, void*&, bool&);
	...
	using Func27 = uint8_t (*)(float&, plg::vec3&, void*&, plg::vec2&, std::vector<int16_t>&, plg::mat4x4&, bool&, plg::vec4&, int8_t&, int32_t&, std::vector<uint8_t>&);
	...
	using Func28 = plg::string (*)(void*&, uint16_t&, std::vector<uint32_t>&, plg::mat4x4&, float&, plg::vec4&, plg::string&, std::vector<uint64_t>&, int64_t&, bool&, plg::vec3&, std::vector<float>&);
	...
	using Func29 = std::vector<plg::string> (*)(plg::vec4&, int32_t&, std::vector<int8_t>&, double&, bool&, int8_t&, std::vector<uint16_t>&, float&, plg::string&, plg::mat4x4&, uint64_t&, plg::vec3&, std::vector<int64_t>&);
	...
	using Func30 = int32_t (*)(void*&, plg::vec4&, int64_t&, std::vector<uint32_t>&, bool&, plg::string&, plg::vec3&, std::vector<uint8_t>&, float&, plg::vec2&, plg::mat4x4&, int8_t&, std::vector<float>&, double&);
	...
	using Func31 = plg::vec3 (*)(char&, uint32_t&, std::vector<uint64_t>&, plg::vec4&, plg::string&, bool&, int64_t&, plg::vec2&, int8_t&, uint16_t&, std::vector<int16_t>&, plg::mat4x4&, plg::vec3&, float&, std::vector<double>&);
	...
	using Func32 = double (*)(int32_t&, uint16_t&, std::vector<int8_t>&, plg::vec4&, void*&, std::vector<uint32_t>&, plg::mat4x4&, uint64_t&, plg::string&, int64_t&, plg::vec2&, std::vector<int8_t>&, bool&, plg::vec3&, uint8_t&, std::vector<char16_t>&);
