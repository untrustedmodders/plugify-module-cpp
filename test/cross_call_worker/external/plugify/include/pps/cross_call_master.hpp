...
namespace cross_call_master {
    ...
    using Func6 = int64_t (*)(const plg::string &, float, const plg::vector<float> &, int16_t,
                              const plg::vector<uint8_t> &, void *);
    using Func7 = double (*)(const plg::vector<char> &, uint16_t, char16_t, const plg::vector<uint32_t> &,
                             const plg::vec4 &, bool, uint64_t);
    using Func8 = plg::mat4x4 (*)(const plg::vec3 &, const plg::vector<uint32_t> &, int16_t, bool, const plg::vec4 &,
                                  const plg::vector<char16_t> &, char16_t, int32_t);
    using Func9 = void (*)(float, const plg::vec2 &, const plg::vector<int8_t> &, uint64_t, bool, const plg::string &,
                           const plg::vec4 &, int16_t, void *);
    using Func10 = uint32_t (*)(const plg::vec4 &, const plg::mat4x4 &, const plg::vector<uint32_t> &, uint64_t,
                                const plg::vector<char> &, int32_t, bool, const plg::vec2 &, int64_t, double);
    using Func11 = void* (*)(const plg::vector<bool> &, char16_t, uint8_t, double, const plg::vec3 &,
                             const plg::vector<int8_t> &, int64_t, uint16_t, float, const plg::vec2 &, uint32_t);
    using Func12 = bool (*)(void *, const plg::vector<double> &, uint32_t, double, bool, int32_t, int8_t, uint64_t,
                            float, const plg::vector<void *> &, int64_t, char);
    using Func13 = plg::string (*)(int64_t, const plg::vector<char> &, uint16_t, float, const plg::vector<bool> &,
                                   const plg::vec4 &, const plg::string &, int32_t, const plg::vec3 &, void *,
                                   const plg::vec2 &, const plg::vector<uint8_t> &, int16_t);
    using Func14 = plg::vector<plg::string> (*)(const plg::vector<char> &, const plg::vector<uint32_t> &,
                                                const plg::mat4x4 &, bool, char16_t, int32_t,
                                                const plg::vector<float> &, uint16_t, const plg::vector<uint8_t> &,
                                                int8_t, const plg::vec3 &, const plg::vec4 &, double, void *);
    using Func15 = int16_t (*)(const plg::vector<int16_t> &, const plg::mat4x4 &, const plg::vec4 &, void *, uint64_t,
                               const plg::vector<uint32_t> &, bool, float, const plg::vector<char16_t> &, uint8_t,
                               int32_t, const plg::vec2 &, uint16_t, double, const plg::vector<uint8_t> &);
    using Func16 = void* (*)(const plg::vector<bool> &, int16_t, const plg::vector<int8_t> &, const plg::vec4 &,
                             const plg::mat4x4 &, const plg::vec2 &, const plg::vector<uint64_t> &,
                             const plg::vector<char> &, const plg::string &, int64_t, const plg::vector<uint32_t> &,
                             const plg::vec3 &, float, double, int8_t, uint16_t);
    ...
    using Func23 = void (*)(uint64_t &, plg::vec2 &, plg::vector<int16_t> &, char16_t &, float &, int8_t &,
                            plg::vector<uint8_t> &);
    using Func24 = plg::mat4x4 (*)(plg::vector<char> &, int64_t &, plg::vector<uint8_t> &, plg::vec4 &, uint64_t &,
                                   plg::vector<void *> &, double &, plg::vector<void *> &);
    using Func25 = double (*)(int32_t &, plg::vector<void *> &, bool &, uint8_t &, plg::string &, plg::vec3 &,
                              int64_t &, plg::vec4 &, uint16_t &);
    using Func26 = char (*)(char16_t &, plg::vec2 &, plg::mat4x4 &, plg::vector<float> &, int16_t &, uint64_t &,
                            uint32_t &, plg::vector<uint16_t> &, void *&, bool &);
    using Func27 = uint8_t (*)(float &, plg::vec3 &, void *&, plg::vec2 &, plg::vector<int16_t> &, plg::mat4x4 &,
                               bool &, plg::vec4 &, int8_t &, int32_t &, plg::vector<uint8_t> &);
    using Func28 = plg::string (*)(void *&, uint16_t &, plg::vector<uint32_t> &, plg::mat4x4 &, float &, plg::vec4 &,
                                   plg::string &, plg::vector<uint64_t> &, int64_t &, bool &, plg::vec3 &,
                                   plg::vector<float> &);
    using Func29 = plg::vector<plg::string> (*)(plg::vec4 &, int32_t &, plg::vector<int8_t> &, double &, bool &,
                                                int8_t &, plg::vector<uint16_t> &, float &, plg::string &,
                                                plg::mat4x4 &, uint64_t &, plg::vec3 &, plg::vector<int64_t> &);
    using Func30 = int32_t (*)(void *&, plg::vec4 &, int64_t &, plg::vector<uint32_t> &, bool &, plg::string &,
                               plg::vec3 &, plg::vector<uint8_t> &, float &, plg::vec2 &, plg::mat4x4 &, int8_t &,
                               plg::vector<float> &, double &);
    using Func31 = plg::vec3 (*)(char &, uint32_t &, plg::vector<uint64_t> &, plg::vec4 &, plg::string &, bool &,
                                 int64_t &, plg::vec2 &, int8_t &, uint16_t &, plg::vector<int16_t> &, plg::mat4x4 &,
                                 plg::vec3 &, float &, plg::vector<double> &);
    using Func32 = double (*)(int32_t &, uint16_t &, plg::vector<int8_t> &, plg::vec4 &, void *&,
                              plg::vector<uint32_t> &, plg::mat4x4 &, uint64_t &, plg::string &, int64_t &, plg::vec2 &,
                              plg::vector<int8_t> &, bool &, plg::vec3 &, uint8_t &, plg::vector<char16_t> &);
    ...
    inline void ReverseReturn(const plg::string &returnString) {
        ...
        if (__func == nullptr)
            plg::GetMethodPtr2("cross_call_master.ReverseReturn", reinterpret_cast<void **>(&__func));
        __func(returnString);
    }
    ...
    inline void NoParamReturnVoidCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnVoidCallback",
    ...
    inline bool NoParamReturnBoolCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnBoolCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline char NoParamReturnChar8Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnChar8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline char16_t NoParamReturnChar16Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnChar16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline int8_t NoParamReturnInt8Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnInt8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline int16_t NoParamReturnInt16Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnInt16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline int32_t NoParamReturnInt32Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnInt32Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline int64_t NoParamReturnInt64Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnInt64Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline uint8_t NoParamReturnUInt8Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnUInt8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline uint16_t NoParamReturnUInt16Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnUInt16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline uint32_t NoParamReturnUInt32Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnUInt32Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline uint64_t NoParamReturnUInt64Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnUInt64Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline void *NoParamReturnPointerCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnPointerCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline float NoParamReturnFloatCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnFloatCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline double NoParamReturnDoubleCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnDoubleCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline NoParamReturnFunctionCallbackFunc NoParamReturnFunctionCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnFunctionCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::string NoParamReturnStringCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnStringCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::any NoParamReturnAnyCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnAnyCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<bool> NoParamReturnArrayBoolCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayBoolCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<char> NoParamReturnArrayChar8Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayChar8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<char16_t> NoParamReturnArrayChar16Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayChar16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<int8_t> NoParamReturnArrayInt8Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayInt8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<int16_t> NoParamReturnArrayInt16Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayInt16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<int32_t> NoParamReturnArrayInt32Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayInt32Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<int64_t> NoParamReturnArrayInt64Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayInt64Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<uint8_t> NoParamReturnArrayUInt8Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayUInt8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<uint16_t> NoParamReturnArrayUInt16Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayUInt16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<uint32_t> NoParamReturnArrayUInt32Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayUInt32Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<uint64_t> NoParamReturnArrayUInt64Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayUInt64Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<void *> NoParamReturnArrayPointerCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayPointerCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<float> NoParamReturnArrayFloatCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayFloatCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<double> NoParamReturnArrayDoubleCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayDoubleCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<plg::string> NoParamReturnArrayStringCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayStringCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<plg::any> NoParamReturnArrayAnyCallback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayAnyCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<plg::vec2> NoParamReturnArrayVector2Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayVector2Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<plg::vec3> NoParamReturnArrayVector3Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayVector3Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<plg::vec4> NoParamReturnArrayVector4Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayVector4Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vector<plg::mat4x4> NoParamReturnArrayMatrix4x4Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnArrayMatrix4x4Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vec2 NoParamReturnVector2Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnVector2Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vec3 NoParamReturnVector3Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnVector3Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::vec4 NoParamReturnVector4Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnVector4Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline plg::mat4x4 NoParamReturnMatrix4x4Callback() {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.NoParamReturnMatrix4x4Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func();
    }
    ...
    inline void Param1Callback(int32_t a) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param1Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a);
    }
    ...
    inline void Param2Callback(int32_t a, float b) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param2Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b);
    }
    ...
    inline void Param3Callback(int32_t a, float b, double c) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param3Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c);
    }
    ...
    inline void Param4Callback(int32_t a, float b, double c, const plg::vec4 &d) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param4Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d);
    }
    ...
    inline void Param5Callback(int32_t a, float b, double c, const plg::vec4 &d, const plg::vector<int64_t> &e) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param5Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d, e);
    }
     ...
     */
    inline void Param6Callback(int32_t a, float b, double c, const plg::vec4 &d, const plg::vector<int64_t> &e,
                               char f) {
        using Param6CallbackFn = void (*)(int32_t, float, double, const plg::vec4 &, const plg::vector<int64_t> &,
                                          char);
        static Param6CallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param6Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d, e, f);
    }
     ...
     */
    inline void Param7Callback(int32_t a, float b, double c, const plg::vec4 &d, const plg::vector<int64_t> &e, char f,
                               const plg::string &g) {
        using Param7CallbackFn = void (*)(int32_t, float, double, const plg::vec4 &, const plg::vector<int64_t> &, char,
                                          const plg::string &);
        static Param7CallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param7Callback",
                                                  reinterpret_cast<void **>(&__func));
     ...
     */
    inline void Param8Callback(int32_t a, float b, double c, const plg::vec4 &d, const plg::vector<int64_t> &e, char f,
                               const plg::string &g, char16_t h) {
        using Param8CallbackFn = void (*)(int32_t, float, double, const plg::vec4 &, const plg::vector<int64_t> &, char,
                                          const plg::string &, char16_t);
        static Param8CallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param8Callback",
                                                  reinterpret_cast<void **>(&__func));
     ...
     */
    inline void Param9Callback(int32_t a, float b, double c, const plg::vec4 &d, const plg::vector<int64_t> &e, char f,
                               const plg::string &g, char16_t h, int16_t k) {
        using Param9CallbackFn = void (*)(int32_t, float, double, const plg::vec4 &, const plg::vector<int64_t> &, char,
                                          const plg::string &, char16_t, int16_t);
        static Param9CallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param9Callback",
                                                  reinterpret_cast<void **>(&__func));
     ...
     */
    inline void Param10Callback(int32_t a, float b, double c, const plg::vec4 &d, const plg::vector<int64_t> &e, char f,
                                const plg::string &g, char16_t h, int16_t k, void *l) {
        using Param10CallbackFn = void (*)(int32_t, float, double, const plg::vec4 &, const plg::vector<int64_t> &,
                                           char, const plg::string &, char16_t, int16_t, void *);
        static Param10CallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.Param10Callback",
                                                  reinterpret_cast<void **>(&__func));
    ...
    inline void ParamRef1Callback(int32_t &a) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef1Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a);
    }
    ...
    inline void ParamRef2Callback(int32_t &a, float &b) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef2Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b);
    }
    ...
    inline void ParamRef3Callback(int32_t &a, float &b, double &c) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef3Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c);
    }
    ...
    inline void ParamRef4Callback(int32_t &a, float &b, double &c, plg::vec4 &d) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef4Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d);
    }
    ...
    inline void ParamRef5Callback(int32_t &a, float &b, double &c, plg::vec4 &d, plg::vector<int64_t> &e) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef5Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d, e);
    }
    ...
    inline void ParamRef6Callback(int32_t &a, float &b, double &c, plg::vec4 &d, plg::vector<int64_t> &e, char &f) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef6Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d, e, f);
    }
     ...
     * @param g (string): No description available.
     */
    inline void ParamRef7Callback(int32_t &a, float &b, double &c, plg::vec4 &d, plg::vector<int64_t> &e, char &f,
                                  plg::string &g) {
        using ParamRef7CallbackFn = void (*)(int32_t &, float &, double &, plg::vec4 &, plg::vector<int64_t> &, char &,
                                             plg::string &);
        static ParamRef7CallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef7Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d, e, f, g);
    }
     ...
     * @param h (char16): No description available.
     */
    inline void ParamRef8Callback(int32_t &a, float &b, double &c, plg::vec4 &d, plg::vector<int64_t> &e, char &f,
                                  plg::string &g, char16_t &h) {
        using ParamRef8CallbackFn = void (*)(int32_t &, float &, double &, plg::vec4 &, plg::vector<int64_t> &, char &,
                                             plg::string &, char16_t &);
        static ParamRef8CallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef8Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d, e, f, g, h);
    }
     ...
     * @param k (int16): No description available.
     */
    inline void ParamRef9Callback(int32_t &a, float &b, double &c, plg::vec4 &d, plg::vector<int64_t> &e, char &f,
                                  plg::string &g, char16_t &h, int16_t &k) {
        using ParamRef9CallbackFn = void (*)(int32_t &, float &, double &, plg::vec4 &, plg::vector<int64_t> &, char &,
                                             plg::string &, char16_t &, int16_t &);
        static ParamRef9CallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef9Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d, e, f, g, h, k);
    }
     ...
     * @param l (ptr64): No description available.
     */
    inline void ParamRef10Callback(int32_t &a, float &b, double &c, plg::vec4 &d, plg::vector<int64_t> &e, char &f,
                                   plg::string &g, char16_t &h, int16_t &k, void *&l) {
        using ParamRef10CallbackFn = void (*)(int32_t &, float &, double &, plg::vec4 &, plg::vector<int64_t> &, char &,
                                              plg::string &, char16_t &, int16_t &, void *&);
        static ParamRef10CallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRef10Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(a, b, c, d, e, f, g, h, k, l);
    }
     ...
     */
    inline void ParamRefVectorsCallback(plg::vector<bool> &p1, plg::vector<char> &p2, plg::vector<char16_t> &p3,
                                        plg::vector<int8_t> &p4, plg::vector<int16_t> &p5, plg::vector<int32_t> &p6,
                                        plg::vector<int64_t> &p7, plg::vector<uint8_t> &p8, plg::vector<uint16_t> &p9,
                                        plg::vector<uint32_t> &p10, plg::vector<uint64_t> &p11,
                                        plg::vector<void *> &p12, plg::vector<float> &p13, plg::vector<double> &p14,
                                        plg::vector<plg::string> &p15) {
        using ParamRefVectorsCallbackFn = void (*)(plg::vector<bool> &, plg::vector<char> &, plg::vector<char16_t> &,
                                                   plg::vector<int8_t> &, plg::vector<int16_t> &,
                                                   plg::vector<int32_t> &, plg::vector<int64_t> &,
                                                   plg::vector<uint8_t> &, plg::vector<uint16_t> &,
                                                   plg::vector<uint32_t> &, plg::vector<uint64_t> &,
                                                   plg::vector<void *> &, plg::vector<float> &, plg::vector<double> &,
                                                   plg::vector<plg::string> &);
        static ParamRefVectorsCallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamRefVectorsCallback",
                                                  reinterpret_cast<void **>(&__func));
     ...
     * @return int64: No description available.
     */
    inline int64_t ParamAllPrimitivesCallback(bool p1, char p2, char16_t p3, int8_t p4, int16_t p5, int32_t p6,
                                              int64_t p7, uint8_t p8, uint16_t p9, uint32_t p10, uint64_t p11,
                                              void *p12, float p13, double p14) {
        using ParamAllPrimitivesCallbackFn = int64_t (*)(bool, char, char16_t, int8_t, int16_t, int32_t, int64_t,
                                                         uint8_t, uint16_t, uint32_t, uint64_t, void *, float, double);
        static ParamAllPrimitivesCallbackFn __func = nullptr;
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamAllPrimitivesCallback",
                                                  reinterpret_cast<void **>(&__func));
    ...
    inline int32_t ParamEnumCallback(Example p1, const plg::vector<Example> &p2) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamEnumCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(p1, p2);
    }
    ...
    inline int32_t ParamEnumRefCallback(Example &p1, plg::vector<Example> &p2) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamEnumRefCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(p1, p2);
    }
    ...
    inline void ParamVariantCallback(const plg::any &p1, const plg::vector<plg::any> &p2) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamVariantCallback",
                                                  reinterpret_cast<void **>(&__func));
        __func(p1, p2);
    }
    ...
    inline void ParamVariantRefCallback(plg::any &p1, plg::vector<plg::any> &p2) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.ParamVariantRefCallback",
                                                  reinterpret_cast<void **>(&__func));
        __func(p1, p2);
    }
    ...
    inline void CallFuncVoidCallback(FuncVoid func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncVoidCallback",
                                                  reinterpret_cast<void **>(&__func));
        __func(func);
    }
    ...
    inline bool CallFuncBoolCallback(FuncBool func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncBoolCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline char CallFuncChar8Callback(FuncChar8 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncChar8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline char16_t CallFuncChar16Callback(FuncChar16 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncChar16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline int8_t CallFuncInt8Callback(FuncInt8 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncInt8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline int16_t CallFuncInt16Callback(FuncInt16 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncInt16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline int32_t CallFuncInt32Callback(FuncInt32 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncInt32Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline int64_t CallFuncInt64Callback(FuncInt64 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncInt64Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline uint8_t CallFuncUInt8Callback(FuncUInt8 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncUInt8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline uint16_t CallFuncUInt16Callback(FuncUInt16 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncUInt16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline uint32_t CallFuncUInt32Callback(FuncUInt32 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncUInt32Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline uint64_t CallFuncUInt64Callback(FuncUInt64 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncUInt64Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline void *CallFuncPtrCallback(FuncPtr func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncPtrCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline float CallFuncFloatCallback(FuncFloat func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncFloatCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline double CallFuncDoubleCallback(FuncDouble func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncDoubleCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFuncStringCallback(FuncString func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncStringCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::any CallFuncAnyCallback(FuncAny func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncAnyCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline void *CallFuncFunctionCallback(FuncFunction func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncFunctionCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<bool> CallFuncBoolVectorCallback(FuncBoolVector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncBoolVectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<char> CallFuncChar8VectorCallback(FuncChar8Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncChar8VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<char16_t> CallFuncChar16VectorCallback(FuncChar16Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncChar16VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<int8_t> CallFuncInt8VectorCallback(FuncInt8Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncInt8VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<int16_t> CallFuncInt16VectorCallback(FuncInt16Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncInt16VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<int32_t> CallFuncInt32VectorCallback(FuncInt32Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncInt32VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<int64_t> CallFuncInt64VectorCallback(FuncInt64Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncInt64VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<uint8_t> CallFuncUInt8VectorCallback(FuncUInt8Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncUInt8VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<uint16_t> CallFuncUInt16VectorCallback(FuncUInt16Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncUInt16VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<uint32_t> CallFuncUInt32VectorCallback(FuncUInt32Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncUInt32VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<uint64_t> CallFuncUInt64VectorCallback(FuncUInt64Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncUInt64VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<void *> CallFuncPtrVectorCallback(FuncPtrVector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncPtrVectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<float> CallFuncFloatVectorCallback(FuncFloatVector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncFloatVectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<double> CallFuncDoubleVectorCallback(FuncDoubleVector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncDoubleVectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<plg::string> CallFuncStringVectorCallback(FuncStringVector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncStringVectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<plg::any> CallFuncAnyVectorCallback(FuncAnyVector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncAnyVectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<plg::vec2> CallFuncVec2VectorCallback(FuncVec2Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncVec2VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<plg::vec3> CallFuncVec3VectorCallback(FuncVec3Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncVec3VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<plg::vec4> CallFuncVec4VectorCallback(FuncVec4Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncVec4VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<plg::mat4x4> CallFuncMat4x4VectorCallback(FuncMat4x4Vector func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncMat4x4VectorCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vec2 CallFuncVec2Callback(FuncVec2 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncVec2Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vec3 CallFuncVec3Callback(FuncVec3 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncVec3Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vec4 CallFuncVec4Callback(FuncVec4 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncVec4Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::mat4x4 CallFuncMat4x4Callback(FuncMat4x4 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncMat4x4Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline int32_t CallFunc1Callback(Func1 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc1Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline char CallFunc2Callback(Func2 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc2Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline void CallFunc3Callback(Func3 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc3Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(func);
    }
    ...
    inline plg::vec4 CallFunc4Callback(Func4 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc4Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline bool CallFunc5Callback(Func5 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc5Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline int64_t CallFunc6Callback(Func6 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc6Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline double CallFunc7Callback(Func7 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc7Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::mat4x4 CallFunc8Callback(Func8 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc8Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline void CallFunc9Callback(Func9 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc9Callback",
                                                  reinterpret_cast<void **>(&__func));
        __func(func);
    }
    ...
    inline uint32_t CallFunc10Callback(Func10 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc10Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline void *CallFunc11Callback(Func11 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc11Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline bool CallFunc12Callback(Func12 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc12Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc13Callback(Func13 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc13Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::vector<plg::string> CallFunc14Callback(Func14 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc14Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline int16_t CallFunc15Callback(Func15 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc15Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline void *CallFunc16Callback(Func16 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc16Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc17Callback(Func17 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc17Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc18Callback(Func18 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc18Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc19Callback(Func19 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc19Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc20Callback(Func20 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc20Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc21Callback(Func21 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc21Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc22Callback(Func22 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc22Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc23Callback(Func23 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc23Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc24Callback(Func24 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc24Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc25Callback(Func25 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc25Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc26Callback(Func26 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc26Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc27Callback(Func27 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc27Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc28Callback(Func28 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc28Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc29Callback(Func29 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc29Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc30Callback(Func30 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc30Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc31Callback(Func31 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc31Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc32Callback(Func32 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc32Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFunc33Callback(Func33 func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFunc33Callback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
    ...
    inline plg::string CallFuncEnumCallback(FuncEnum func) {
        ...
        if (__func == nullptr) plg::GetMethodPtr2("cross_call_master.CallFuncEnumCallback",
                                                  reinterpret_cast<void **>(&__func));
        return __func(func);
    }
} // namespace cross_call_master
