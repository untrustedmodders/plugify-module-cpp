...
namespace cross_call_worker {
	...
	inline void Param5(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e) {
		using Param5Fn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&);
		static Param5Fn __func = nullptr;
		if (__func == nullptr) plg::GetMethodPtr2("cross_call_worker.Param5", reinterpret_cast<void**>(&__func));
		__func(a, b, c, d, e);
	}
	inline void Param6(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f) {
		using Param6Fn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char);
		static Param6Fn __func = nullptr;
		if (__func == nullptr) plg::GetMethodPtr2("cross_call_worker.Param6", reinterpret_cast<void**>(&__func));
		__func(a, b, c, d, e, f);
	}
	inline void Param7(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f, const plg::string& g) {
		using Param7Fn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char, const plg::string&);
	...
	inline void Param8(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f, const plg::string& g, char16_t h) {
		using Param8Fn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char, const plg::string&, char16_t);
	...
	inline void Param9(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f, const plg::string& g, char16_t h, int16_t k) {
		using Param9Fn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char, const plg::string&, char16_t, int16_t);
	...
	inline void Param10(int32_t a, float b, double c, const plg::vec4& d, const std::vector<int64_t>& e, char f, const plg::string& g, char16_t h, int16_t k, void* l) {
		using Param10Fn = void (*)(int32_t, float, double, const plg::vec4&, const std::vector<int64_t>&, char, const plg::string&, char16_t, int16_t, void*);
	...
	inline void ParamRef5(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e) {
		using ParamRef5Fn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&);
	...
	inline void ParamRef6(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f) {
		using ParamRef6Fn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&);
	...
	inline void ParamRef7(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f, plg::string& g) {
		using ParamRef7Fn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&, plg::string&);
	...
	inline void ParamRef8(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f, plg::string& g, char16_t& h) {
		using ParamRef8Fn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&, plg::string&, char16_t&);
	...
	inline void ParamRef9(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f, plg::string& g, char16_t& h, int16_t& k) {
		using ParamRef9Fn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&, plg::string&, char16_t&, int16_t&);
	...
	inline void ParamRef10(int32_t& a, float& b, double& c, plg::vec4& d, std::vector<int64_t>& e, char& f, plg::string& g, char16_t& h, int16_t& k, void*& l) {
		using ParamRef10Fn = void (*)(int32_t&, float&, double&, plg::vec4&, std::vector<int64_t>&, char&, plg::string&, char16_t&, int16_t&, void*&);
	...
	inline std::vector<bool> CallFuncBoolVector(FuncBoolVector func) {
	...
	inline std::vector<char> CallFuncChar8Vector(FuncChar8Vector func) {
	...
	inline std::vector<char16_t> CallFuncChar16Vector(FuncChar16Vector func) {
	...
	inline std::vector<int8_t> CallFuncInt8Vector(FuncInt8Vector func) {
	...
	inline std::vector<int16_t> CallFuncInt16Vector(FuncInt16Vector func) {
	...
	inline std::vector<int32_t> CallFuncInt32Vector(FuncInt32Vector func) {
	...
	inline std::vector<int64_t> CallFuncInt64Vector(FuncInt64Vector func) {
	...
	inline std::vector<uint8_t> CallFuncUInt8Vector(FuncUInt8Vector func) {
	...
	inline std::vector<uint16_t> CallFuncUInt16Vector(FuncUInt16Vector func) {
	...
	inline std::vector<uint32_t> CallFuncUInt32Vector(FuncUInt32Vector func) {
	...
	inline std::vector<uint64_t> CallFuncUInt64Vector(FuncUInt64Vector func) {
	...
	inline std::vector<void*> CallFuncPtrVector(FuncPtrVector func) {
	...
	inline std::vector<float> CallFuncFloatVector(FuncFloatVector func) {
	...
	inline std::vector<plg::string> CallFuncStringVector(FuncStringVector func) {
	...
	inline std::vector<double> CallFuncDoubleVector(FuncDoubleVector func) {
	...
	inline std::vector<plg::string> CallFunc14(Func14 func) {
